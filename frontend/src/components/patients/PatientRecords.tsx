                  ...
                  <>
                    ...
                    <TabsContent value="health-records" className="space-y-3">
                      {healthRecords.length === 0 ? (
                        ...
                        healthRecords.map((record, index) => (
                          <div
                            key={record.record_id || record.report_id || record.id || `hr-${index}`}
                    ...
                    <TabsContent value="lab-reports" className="space-y-3">
                      {labReports.length === 0 ? (
                        ...
                        labReports.map((report, index) => (
                          <div
                            key={report.report_id || report.id || `lr-${index}`}
                    ...
                    <TabsContent value="vaccinations" className="space-y-3">
                      {vaccinationRecords.length === 0 ? (
                        ...
                        vaccinationRecords.map((record, index) => (
                          <div
                            key={record.record_id || record.id || `vr-${index}`}
                            className="p-4 rounded-lg border bg-slate-50"
                          >
                            <div className="flex items-center gap-3">
                    ...
                    <TabsContent value="diseases" className="space-y-3">
                      {diseaseCases.length === 0 ? (
                        ...
                        diseaseCases.map((diseaseCase, index) => (
                          <div
                            key={diseaseCase.case_id || diseaseCase.id || `dc-${index}`}
                            className="p-4 rounded-lg border bg-slate-50"
                          >
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
